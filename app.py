    ...
    if not orders_df.empty:
        ...
        with ecol1:
            if st.button("Export XML for TOTAL"):
                ...
                xml_lines.append(f'    <APPRAISER _Name="{appraiser_name}" _CompanyName="A-Tech Appraisal Co., LLC" _StreetAddress="" _City="" _State="RI" _PostalCode="">')
                ...
                xml_lines.append(f'      <INSPECTION AppraisalInspectionPropertyType="Subject" InspectionDate="" />')
                ...
                # PROPERTY section
                xml_lines.append(f'  <PROPERTY _StreetAddress="{addr}" _City="{city}" _State="{state}" _PostalCode="{zipcode}" _County="" _RightsTypeOtherDescription="">')
                xml_lines.append(f'    <_IDENTIFICATION AssessorsParcelIdentifier="" MapReferenceIdentifier="" CensusTractIdentifier="">')
                ...
                xml_lines.append(f'            <PARCEL_IDENTIFIER GSEAssessorsParcelIdentifier="" />')
                xml_lines.append(f'          </PROPERTY_IDENTIFICATION_EXTENSION_SECTION_DATA>')
                xml_lines.append(f'        </PROPERTY_IDENTIFICATION_EXTENSION_SECTION>')
                xml_lines.append(f'      </PROPERTY_IDENTIFICATION_EXTENSION>')
                xml_lines.append(f'    </_IDENTIFICATION>')
                xml_lines.append(f'    <_LEGAL_DESCRIPTION _Type="Other" _TypeOtherDescription="LongLegal" _TextDescription="" />')
                # STRUCTURE
                xml_lines.append(f'    <STRUCTURE StoriesCount="" _DesignDescription="" PropertyStructureBuiltYear="" TotalRoomCount="" TotalBedroomCount="" TotalBathroomCount="" GrossLivingAreaSquareFeetCount="">')
                xml_lines.append(f'      <FOUNDATION _Type="Basement" _ConditionDescription="Full" _ExistsIndicator="N">')
                xml_lines.append(f'        <_CONDITION _Type="Infestation" _Comment="" />')
                xml_lines.append(f'      </FOUNDATION>')
                xml_lines.append(f'      <BASEMENT SquareFeetCount="" _FinishedPercent="" />')
                ...
                xml_lines.append(f'      <HEATING _FuelDescription="" />')
                xml_lines.append(f'      <COOLING />')
                ...
                xml_lines.append(f'        <CAR_STORAGE_LOCATION _Type="Garage" ParkingSpacesCount="" />')
                ...
                xml_lines.append(f'            <STRUCTURE_INFORMATION GSEYearBuiltEstimationIndicator="N" GSEStoriesCount="" />')
                xml_lines.append(f'          </STRUCTURE_EXTENSION_SECTION_DATA>')
                ...
                # SITE
                xml_lines.append(f'    <SITE _DimensionsDescription="" _AreaDescription="" _ZoningClassificationIdentifier="" _ZoningClassificationDescription="" _ZoningComplianceDescription="" HighestBestUseDescription="">')
                ...
                xml_lines.append(f'      <FLOOD_ZONE NFIPFloodZoneIdentifier="" NFIPMapIdentifier="" NFIPMapPanelDate="">')
                ...
                xml_lines.append(f'              <FLOOD_ZONE_INFORMATION GSENFIPFloodZoneIdentifier="" GSEFEMAFloodMapIdentifier="" />')
                xml_lines.append(f'            </FLOOD_ZONE_EXTENSION_SECTION_DATA>')
                ...
                # NEIGHBORHOOD
                xml_lines.append(f'    <NEIGHBORHOOD _Name="" _BoundaryAndCharacteristicsDescription="" _Description="" _MarketConditionsDescription="">')
                ...
                xml_lines.append(f'      <_PRESENT_LAND_USE _Type="Other" _TypeOtherDescription="Other" _Percent="" />')
                ...
                # TAX
                xml_lines.append(f'    <_TAX _YearIdentifier="" _TotalTaxAmount="" _TotalSpecialTaxAmount="">')
                ...
                xml_lines.append(f'            <PROPERTY_TAX_AMOUNT GSEPropertyTaxTotalTaxAmount="" />')
                xml_lines.append(f'          </PROPERTY_TAX_EXTENSION_SECTION_DATA>')
                ...
                xml_lines.append(f'    <PROPERTY_ANALYSIS _Type="ConformsToNeighborhood" _Comment="" />')
                xml_lines.append(f'    <PROPERTY_ANALYSIS _Type="UtilitiesAndOffSiteImprovementsConformToNeighborhood" _Comment="" />')
                xml_lines.append(f'    <PROPERTY_ANALYSIS _Type="AdverseSiteConditions" _Comment="" />')
                ...
                xml_lines.append(f'    <COST_ANALYSIS SiteEstimatedValueComment="" DataSourceDescription="" CostServiceQualityRatingDescription="" DataSourceEffectiveDate="" _Comment="" EstimatedRemainingEconomicLifeYearsCount="" SiteEstimatedValueAmount="" NewImprovementTotalCostAmount="" NewImprovementDepreciatedCostAmount="" SiteOtherImprovementsAsIsAmount="" ValueIndicatedByCostApproachAmount="">')
                xml_lines.append(f'      <NEW_IMPROVEMENT _Type="Dwelling" SquareFeetCount="" PricePerSquareFootAmount="" _CostAmount="" />')
                ...
                xml_lines.append(f'    <SALES_COMPARISON _CurrentSalesAgreementAnalysisComment="" _Comment="" ValueIndicatedBySalesComparisonApproachAmount="">')
                ...
                # VALUATION section
                xml_lines.append(f'  <VALUATION PropertyAppraisedValueAmount="{val_opinion}" AppraisalEffectiveDate="">')
                xml_lines.append(f'    <_RECONCILIATION _SummaryComment="" _ConditionsComment="" />')
